...
Vue.prototype.$event = function (event_name, from) {
  ...
  xhr.setRequestHeader(
    "X-CSRF-TOKEN",
    sessionStorage.getItem("behavior_csrf_token")
  );
  if (from == null) {
...
const DownloadView = () =>
  import(/* webpackChunkName: "group-foo" */ "./DownloadView.vue");
const HomeView = () =>
  import(/* webpackChunkName: "group-foo" */ "./HomeView.vue");
const UploadView = () =>
  import(/* webpackChunkName: "group-foo" */ "./UploadView.vue");
const UploadedRecodeView = () =>
  import(/* webpackChunkName: "group-foo" */ "./UploadedRecodeView.vue");
const FilelistView = () =>
  import(/* webpackChunkName: "group-foo" */ "./FilelistView.vue");
const Terms = () => import(/* webpackChunkName: "group-foo" */ "./Terms.vue");
const Privacy = () =>
  import(/* webpackChunkName: "group-foo" */ "./Privacy.vue");
